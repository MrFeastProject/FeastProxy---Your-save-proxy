...
-keep class MrFeastProject.FeastProxy.com.NativeProxy { *; }
-keep interface MrFeastProject.FeastProxy.com.ProxyLibrary { *; }
-keepclassmembers class * extends com.sun.jna.Library {
    <methods>;
}

# ─── ProxyService (foreground service, must not be obfuscated) ───
-keep class MrFeastProject.FeastProxy.com.ProxyService { *; }
