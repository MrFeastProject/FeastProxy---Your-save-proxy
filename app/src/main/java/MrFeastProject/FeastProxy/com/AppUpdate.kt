...
private const val UPDATE_LOG_TAG = "FeastProxy"
private const val GITHUB_RELEASES_URL = "https://api.github.com/repos/MrFeastProject/FeastProxy---Your-save-proxy/releases?per_page=30"
private const val GITHUB_LATEST_RELEASE_URL = "https://api.github.com/repos/MrFeastProject/FeastProxy---Your-save-proxy/releases/latest"
private const val GITHUB_LATEST_RELEASE_WEB_URL = "https://github.com/MrFeastProject/FeastProxy---Your-save-proxy/releases/latest"
private const val GITHUB_RELEASE_TAG_URL_PREFIX = "https://github.com/MrFeastProject/FeastProxy---Your-save-proxy/releases/tag/"
private const val GITHUB_TAGS_URL = "https://api.github.com/repos/MrFeastProject/FeastProxy---Your-save-proxy/tags?per_page=100"
private const val GITHUB_TAG_TREE_URL_PREFIX = "https://github.com/MrFeastProject/FeastProxy---Your-save-proxy/tree/"
...
private fun fetchReleaseFromLatestWebRedirect(): AppReleaseInfo? {
    ...
    return try {
        ...
        conn.setRequestProperty("User-Agent", "FeastProxyAndroid/${BuildConfig.VERSION_NAME}")
