...
fun openTelegram(context: Context, url: String) {
    try {
        ...
        Toast.makeText(
            context,
            MrFeastProject.FeastProxy.com.R.string.telegram_not_found,
            Toast.LENGTH_SHORT
        ).show()
    }
}
...
fun SettingsTab(settingsStore: SettingsStore) {
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(MrFeastProject.FeastProxy.com.R.string.settings),
        ...
        AppSectionCard {
            Column(
                ...
                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Text(
                        stringResource(MrFeastProject.FeastProxy.com.R.string.connection),
            ...
            Column(
                ...
                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Text(
                        stringResource(MrFeastProject.FeastProxy.com.R.string.ws_pool),
                        style = MaterialTheme.typography.titleSmall,
                        color = MaterialTheme.colorScheme.primary,
                        fontWeight = FontWeight.SemiBold
                    )
            ...
            Column(
                ...
                Row(
                    ...
                    Text(
                        stringResource(MrFeastProject.FeastProxy.com.R.string.secret_key),
                        style = MaterialTheme.typography.titleSmall,
                        color = MaterialTheme.colorScheme.primary,
                        fontWeight = FontWeight.SemiBold
                    )
            ...
            Row(
                ...
                Row(
                    ...
                    Text(
                        stringResource(MrFeastProject.FeastProxy.com.R.string.autostart),
                        style = MaterialTheme.typography.titleSmall,
                        color = MaterialTheme.colorScheme.primary,
                        fontWeight = FontWeight.SemiBold
                    )
    ...
    Dialog(
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    stringResource(MrFeastProject.FeastProxy.com.R.string.dc_addresses),
                ...
                Column(
                    ...
                    if (isExperimental) {
                        ...
                        Text(stringResource(MrFeastProject.FeastProxy.com.R.string.media_dcs), style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                ...
                Row(
                    ...
                    Text(
                        stringResource(MrFeastProject.FeastProxy.com.R.string.experimental_mode),
                ...
                Button(
                    ...
                    Text(stringResource(MrFeastProject.FeastProxy.com.R.string.done), fontWeight = FontWeight.SemiBold)
                }
            }
        }
    }
